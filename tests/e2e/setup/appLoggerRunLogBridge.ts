/**
 * Condensed single-line formatting for `app_logger` rows. Payloads come from the Vitest
 * `Logger` mock in `e2eVitestSetup.ts`, which forwards to `getE2eRunLogger()` in `runLogger.ts`.
 */

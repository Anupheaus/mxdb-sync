...
// export function generateSyncRecordFromCurrentRecord<RecordType extends Record, SyncRecordType extends MXDBSyncRecord<RecordType>>(currentRecord: RecordType,
// // syncRecord: SyncRecordType | undefined, userId: string, syncTime: number = generateSyncTime()): SyncRecordType {
